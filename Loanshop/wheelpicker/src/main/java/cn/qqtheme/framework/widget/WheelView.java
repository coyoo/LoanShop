...
import cn.qqtheme.framework.util.*;
...
public class WheelView extends View {
    ...
    public static final int TEXT_COLOR_FOCUS = 0Xff487af6;
    public static final int TEXT_COLOR_NORMAL = 0XFFBBBBBB;
    public static final int DIVIDER_COLOR = 0Xff487af6;
    public static final int DIVIDER_ALPHA = 22;
