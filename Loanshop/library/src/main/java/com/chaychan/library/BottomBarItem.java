...
public class BottomBarItem extends LinearLayout {
    ...
    private void checkValues() {
        if (normalIcon == null) {
            throw new IllegalStateException("You have not set the normal icon_home");
        }

        if (selectedIcon == null) {
            throw new IllegalStateException("You have not set the selected icon_home");
        }
    ...
    public static final class Builder {
        ...
        /**
         * Sets the default icon_home's resourceId
         */
        ...
        /**
         * Sets the selected icon_home's resourceId
         */
