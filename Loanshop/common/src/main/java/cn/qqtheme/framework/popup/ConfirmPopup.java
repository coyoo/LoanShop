...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int pressedTextColor = Color.WHITE;
    ...
    public void setSubmitBgColor(@DrawableRes int submitBgColor) {
        if (null != submitButton) {
            submitButton.setBackground(context.getResources().getDrawable(submitBgColor));
        } else {
//            this.submitTextColor = submitBgColor;
        }
    }
    ...
    protected final View makeContentView() {
        ...
        rootLayout.setBackground(context.getResources().getDrawable(R.drawable.whitecolor_bt_bg));
...
//        topButtonLayout.setBackgroundColor(topBackgroundColor);
        topButtonLayout.setBackground(context.getResources().getDrawable(R.drawable.whitecolor_bt_bg));
        ...
        submitParams.topMargin=20;
        submitParams.bottomMargin=20;
        submitParams.rightMargin=25;
        submitParams.leftMargin=25;
        submitButton.setLayoutParams(submitParams);
//        submitButton.setBackgroundColor(Color.TRANSPARENT);
        submitButton.setBackground(context.getResources().getDrawable(R.drawable.redcolor_bt_bg));
